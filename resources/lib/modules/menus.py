...
def main_menu():
    ...
    if changelog_dir not in ['', 'http://', 'http://CHANGEME/'] and CURRENT_BUILD not in ['No Build Installed', 'No Build']:
        add_dir(COLOR2('View Build Changelog'), '', 101, addon_icon, addon_fanart, COLOR2(local_string(30109)), isFolder=False)

    add_dir(COLOR2(local_string(30013)), '', 100, addon_icon, addon_fanart, COLOR2(local_string(30014)), isFolder=False)
    ...
    add_dir(COLOR2(local_string(30015)), 'Addon.OpenSettings(plugin.program.valarswizard)', 25, addon_icon, addon_fanart, COLOR2(local_string(30016)), isFolder=False)
...
def submenu_maintenance():
    ...
    add_dir(COLOR2(local_string(30012)), '', 4, addon_icon, addon_fanart, COLOR2(local_string(30003)), isFolder=False)
    if '20' in kodi_ver:
    ...
    add_dir(COLOR1('<><> [B]Cleaning[/B] <><>'), '', '', addon_icon, addon_fanart, COLOR1('Manual cleaning tools'), isFolder=False)
    ...
    add_dir(COLOR2('Clear Cache'), '', 33, addon_icon, addon_fanart, COLOR2('Clear Kodi cache/temp folders'), isFolder=False)
